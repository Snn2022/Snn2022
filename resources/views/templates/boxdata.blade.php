        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-dark">
                    ...
                    <a href="{{route('products')}}" class="btn btn-dark small-box-footer">
                        <h5 class="text-default text-bold">More &nbsp; <i class="fas fa-arrow-circle-right"></i>
                        </h5>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-primary">
                    ...
                    <a href="{{route('orders')}}" class="btn btn-primary small-box-footer">
                        <h5 class="text-default text-bold">More &nbsp; <i class="fas fa-arrow-circle-right"></i>
                        </h5>
                    </a>
                </div>
